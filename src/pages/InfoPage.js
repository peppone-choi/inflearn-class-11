      ...
      >
        ...
        <div>
          <div className="flex items-center justify-between">
            <p className="ml-10">{pokemonData.height}m</p>
          ...
          <div className="m-5 text-center w-96">
            <p>{speciesData.koreanFlavorText}</p>
          </div>
        </div>
        <div>
          <div className="flex items-center justify-between w-96 ">
            <button type="button" className="mr-24 text-4xl size-11" onClick={back}>
              <p>{'<'}</p>
            </button>

            <p>{speciesData.id}</p>
            <p>{speciesData.name}</p>
            <button type="button" className="ml-24 text-4xl size-11" onClick={foward}>
              <p>{'>'}</p>
            </button>
          </div>
        </div>
